...
#             bold_lines = ["Company Name:", "Industry:", "Sector:", "Business Description:", "Market Position:", "Key Statistics:", "Financial Health:", "Analyst Insights:", "Market & Competition Risks:", "1. Market Sensitivity Risk", "2. Industry Competition Risk"]
...
#         # Strengths and Catalysts section
...
#         # Investment Thesis and Risk Analysis section
#         risk_content_list = []
#         financial_insights = []
#         analyst_insights = []
...
#             dividend_info.append(f"Ex-Dividend Date: {div_date}")
#             if all_content['info'].get('dividendRate'):
#                 dividend_info.append(f"Dividend Rate: ${all_content['info']['dividendRate']:.2f}")
#             if all_content['info'].get('dividendYield'):
#                 dividend_info.append(f"Dividend Yield: {all_content['info']['dividendYield']*100:.2f}%")
...
#                 # Add dividend information right after Financial Health header
#                 for div_line in dividend_info:
#                     financial_insights.append(Paragraph(div_line, normal_style))
...
#         left_wrapper = Table([[left_analysis]], colWidths=[doc.width/2.0 - 20])
...
#         # Events section (only earnings date, no dividend info)
#         events_content_list = []
#         events_lines = events_content.split('\n')
#         for line in events_lines:
#             if "UPCOMING EVENTS" in line or "Next Earnings Date:" in line:
#                 events_content_list.append(Paragraph(line, normal_style))
        
#         for item in events_content_list:
#             story.append(item)
